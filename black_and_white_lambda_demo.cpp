...
static aws::lambda_runtime::invocation_response my_handler(aws::lambda_runtime::invocation_request const& req, Aws::S3::S3Client const& client) {
    AWS_LOGSTREAM_INFO(TAG, "Started my_handler.")
    ...
    AWS_LOGSTREAM_INFO(TAG, "Retrieved image from S3Bucket")
    ...
    AWS_LOGSTREAM_INFO(TAG, "Transformed the image to Black and White")
    Aws::S3::Model::PutObjectRequest request;
    request.SetBucket("black-and-white-image-9e6a73f2-5914-4397-937f-803f00a78102");
    request.SetKey(key);
    ...
    AWS_LOGSTREAM_INFO(TAG, "my_handler ready.")
    AWS_LOGSTREAM_FLUSH()
